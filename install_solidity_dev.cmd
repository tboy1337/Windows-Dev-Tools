...
echo [1/5] Installing/Updating Foundry...
echo.
...
echo [2/5] Installing/Updating Aderyn...
%PYTHON_CMD% -m pip install --upgrade aderyn
echo.

echo [3/5] Installing/Updating solc-select...
%PYTHON_CMD% -m pip install --upgrade solc-select
echo.

echo [4/5] Installing/Updating Code Quality Tools...
call npm install -g prettier prettier-plugin-solidity
echo.

echo [5/5] Installing/Updating Solhint...
